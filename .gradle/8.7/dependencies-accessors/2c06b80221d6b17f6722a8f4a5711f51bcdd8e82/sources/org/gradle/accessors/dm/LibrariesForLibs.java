...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final FloatingLibraryAccessors laccForFloatingLibraryAccessors = new FloatingLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>floating</b>
     */
    public FloatingLibraryAccessors getFloating() {
        return laccForFloatingLibraryAccessors;
    }
    ...
    public static class FloatingLibraryAccessors extends SubDependencyFactory {
        private final FloatingActionLibraryAccessors laccForFloatingActionLibraryAccessors = new FloatingActionLibraryAccessors(owner);

        public FloatingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>floating.action</b>
         */
        public FloatingActionLibraryAccessors getAction() {
            return laccForFloatingActionLibraryAccessors;
        }

    }

    public static class FloatingActionLibraryAccessors extends SubDependencyFactory {

        public FloatingActionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>button</b> with <b>com.getbase:floatingactionbutton</b> coordinates and
         * with version <b>1.10.1</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getButton() {
            return create("floating.action.button");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ksp</b> with value <b>1.7.20-1.0.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
